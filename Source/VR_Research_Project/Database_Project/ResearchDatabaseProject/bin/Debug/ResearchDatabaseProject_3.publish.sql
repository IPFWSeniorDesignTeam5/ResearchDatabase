...
GO
ALTER TABLE [dbo].[Application] ALTER COLUMN [GeneralDescription] VARCHAR (1200) NULL;

ALTER TABLE [dbo].[Application] ALTER COLUMN [MechanicDescription] VARCHAR (1200) NULL;
