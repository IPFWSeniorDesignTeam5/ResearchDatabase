...
GO
PRINT N'Creating [dbo].[ReviewCon]...';
...
GO
PRINT N'Creating [dbo].[ReviewPro]...';
...
ALTER TABLE [dbo].[Review]
    ADD DEFAULT getdate() FOR [ReviewDate];
...
ALTER TABLE [dbo].[ApplicationGenre]
    ADD CONSTRAINT [FK_ApplicationGenre_ToApplication] FOREIGN KEY ([ApplicationId]) REFERENCES [dbo].[Application] ([Id]) ON DELETE CASCADE;
...
GO
ALTER TABLE [dbo].[ApplicationGenre]
    ADD CONSTRAINT [FK_ApplicationGenre_ToGenre] FOREIGN KEY ([GenreId]) REFERENCES [dbo].[Genre] ([Id]) ON DELETE CASCADE;
...
ALTER TABLE [dbo].[ApplicationMechanic]
    ADD CONSTRAINT [FK_ApplicationMechanic_ToApplication] FOREIGN KEY ([ApplicationId]) REFERENCES [dbo].[Application] ([Id]) ON DELETE CASCADE;
...
GO
ALTER TABLE [dbo].[ApplicationMechanic]
    ADD CONSTRAINT [FK_ApplicationMechanic_ToMechanic] FOREIGN KEY ([MechanicId]) REFERENCES [dbo].[Mechanic] ([Id]) ON DELETE CASCADE;
...
ALTER TABLE [dbo].[ApplicationReview]
    ADD CONSTRAINT [FK_ApplicationReview_ToApplication] FOREIGN KEY ([ApplicationId]) REFERENCES [dbo].[Application] ([Id]) ON DELETE CASCADE;
...
GO
ALTER TABLE [dbo].[ApplicationReview]
    ADD CONSTRAINT [FK_ApplicationReview_ToReview] FOREIGN KEY ([ReviewId]) REFERENCES [dbo].[Review] ([Id]) ON DELETE CASCADE;


GO
PRINT N'Creating [dbo].[FK_ReviewCon_ToReview]...';


GO
ALTER TABLE [dbo].[ReviewCon]
    ADD CONSTRAINT [FK_ReviewCon_ToReview] FOREIGN KEY ([ReviewId]) REFERENCES [dbo].[Review] ([Id]) ON DELETE CASCADE;


GO
PRINT N'Creating [dbo].[FK_ReviewCon_ToPro]...';


GO
ALTER TABLE [dbo].[ReviewCon]
    ADD CONSTRAINT [FK_ReviewCon_ToPro] FOREIGN KEY ([AppConId]) REFERENCES [dbo].[AppCon] ([Id]) ON DELETE CASCADE;


GO
PRINT N'Creating [dbo].[FK_ReviewPro_ToReview]...';


GO
ALTER TABLE [dbo].[ReviewPro]
    ADD CONSTRAINT [FK_ReviewPro_ToReview] FOREIGN KEY ([ReviewId]) REFERENCES [dbo].[Review] ([Id]) ON DELETE CASCADE;


GO
PRINT N'Creating [dbo].[FK_ReviewPro_ToPro]...';


GO
ALTER TABLE [dbo].[ReviewPro]
    ADD CONSTRAINT [FK_ReviewPro_ToPro] FOREIGN KEY ([AppProId]) REFERENCES [dbo].[AppPro] ([Id]) ON DELETE CASCADE;


GO
PRINT N'Creating [dbo].[VW_GenrePairs]...';
...
GO
PRINT N'Creating [dbo].[VW_GenreReview]...';
...
GO
PRINT N'Creating [dbo].[VW_Genres]...';
...
CREATE VIEW [dbo].[VW_Genres]
	AS SELECT Genre.Description,
			  ...
			  GROUP BY Genre.Description;
GO
PRINT N'Creating [dbo].[VW_MechanicPair]...';
...
CREATE VIEW [dbo].[VW_MechanicPair]
	...
	GROUP BY G1Description + '/' + G2Description;
GO
PRINT N'Creating [dbo].[VW_MechanicReview]...';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '03044e43-57bb-4718-b7fb-54708387b1b5')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('03044e43-57bb-4718-b7fb-54708387b1b5')
