...
GO
PRINT N'Dropping [dbo].[FK_Application_ToPlatform]...';


GO
ALTER TABLE [dbo].[Application] DROP CONSTRAINT [FK_Application_ToPlatform];
...
GO
ALTER TABLE [dbo].[Application] ALTER COLUMN [Platform] INT NULL;
...
GO
ALTER TABLE [dbo].[Application] WITH CHECK CHECK CONSTRAINT [FK_Application_ToPlatform];
