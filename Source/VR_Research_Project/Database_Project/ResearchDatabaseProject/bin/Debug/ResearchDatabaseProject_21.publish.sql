...
GO
PRINT N'Altering [dbo].[VW_GenreReview]...';


GO
ALTER VIEW [dbo].[VW_GenreReview]
	AS SELECT        Genre.Description, SUM(Review.TimeSpent) AS ReviewTime, AVG(CAST(Review.Rating AS FLOAT),2) AS AverageRating
...
GO
PRINT N'Altering [dbo].[VW_MechanicReview]...';


GO
ALTER VIEW [dbo].[VW_MechanicReview]
	AS SELECT        Mechanic.Description, SUM(Review.TimeSpent) AS ReviewTime, AVG(CAST(Review.Rating AS FLOAT)) AS AverageRating
FROM            Application INNER JOIN
                         ApplicationReview ON Application.Id = ApplicationReview.ApplicationId INNER JOIN
                         Review ON ApplicationReview.ReviewId = Review.Id INNER JOIN
